...
`--pull` prints what it would change and waits for a `y`. Run it straight after a `git pull`
and it will offer to replace what you just pulled with the older values still live at Vapi —
that is the moment to answer `n`.
